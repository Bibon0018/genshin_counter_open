...
class MobCountWidget extends StatelessWidget {
  final MobFragments data;
  final MobFragments have;
  final List<Hero.Hero> heroes;
  const MobCountWidget(
              ...
              children: [
                Expanded(
                  child: FragmentCountWidget(
                    ...
                    data: data.lvl1,
                    image: data.lvl1.imagePath.mobFragmentsImagePath(),
                    ...
                    onTap: () {
                      final tooltip = customTooltip(
                        [
                          ...heroes
                              .where((e) =>
                                  FragmentCounter.mobFragment([e]).lvl1.count >
                                  0)
                              .map((e) => HeroCount(
                                  imagePath: e.imagePath.heroImagePath(),
                                  count: FragmentCounter.mobFragment([e])
                                      .lvl1
                                      .count))
                        ],
                      );
                ...
                Expanded(
                  child: FragmentCountWidget(
                    ...
                    data: data.lvl2,
                    image: data.lvl2.imagePath.mobFragmentsImagePath(),
                    ...
                    onTap: () {
                      final tooltip = customTooltip(
                        [
                          ...heroes
                              .where((e) =>
                                  FragmentCounter.mobFragment([e]).lvl2.count >
                                  0)
                              .map((e) => HeroCount(
                                  imagePath: e.imagePath.heroImagePath(),
                                  count: FragmentCounter.mobFragment([e])
                ...
                Expanded(
                  child: FragmentCountWidget(
                    ...
                    data: data.lvl3,
                    image: data.lvl3.imagePath.mobFragmentsImagePath(),
                    ...
                    onTap: () {
                      final tooltip = customTooltip(
                        [
                          ...heroes
                              .where((e) =>
                                  FragmentCounter.mobFragment([e]).lvl3.count >
                                  0)
                              .map((e) => HeroCount(
                                  imagePath: e.imagePath.heroImagePath(),
                                  count: FragmentCounter.mobFragment([e])
